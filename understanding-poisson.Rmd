...
plot(1:20, dbinom(1:20, size=20, prob=.2), type="o", col=2, ylab="P(X=k)", xlab="k", main="Binomial distribution with n=20")
points(1:20, dbinom(1:20, size=20, prob=.5), type="o", col=3)
points(1:20, dbinom(1:20, size=20, prob=.7), type="o", col=4)
legend("topright", legend=c("p = 0.2", "p = 0.5", "p = 0.7"), col=2:4, lty=1)
```

```{r fig.width=7, fig.height=6}
plot(1:100, dbinom(1:100, size=100, prob=.2), type="o", col=2, ylab="P(X=k)", xlab="k", main="Binomial distribution with n=100")
points(1:100, dbinom(1:100, size=100, prob=.5), type="o", col=3)
points(1:100, dbinom(1:100, size=100, prob=.7), type="o", col=4)
legend("topright", legend=c("p = 0.2", "p = 0.5", "p = 0.7"), col=2:4, lty=1)
```
...
```{r fig.width=7, fig.height=6}
plot(1:20, dbinom(1:20, size=20, prob=.5), type="o", col=2, ylab="P(X=k)", xlab="k", main="Binom dist for n=20 when we know mean(k)=10")
legend("topright", legend="p=0.5 (because 20*.5=10)", col=2, lty=1)
```

```{r fig.width=7, fig.height=6}
plot(1:50, dbinom(1:50, size=50, prob=.2), type="o", col=3, ylab="P(X=k)", xlab="k", main="Binom dist for n=50 when we know mean(k)=10")
legend("topright", legend="p=0.2 (because 50*.2=10)", col=3, lty=1)
```

```{r fig.width=7, fig.height=6}
plot(1:1000, dbinom(1:1000, size=1000, prob=.01), type="o", col=4, ylab="P(X=k)", xlab="k", main="Binom dist for n=1000 when we know mean(k)=10")
...
```{r fig.width=7, fig.height=6}
plot(1:20, dbinom(1:20, size=20, prob=.5), type="o", col=2, ylab="P(X=k)", xlab="k", main="Binom dist for various n's around k=10 when mean(k)=10")
points(1:20, dbinom(1:20, size=50, prob=.2), type="o", col=3)
points(1:20, dbinom(1:20, size=1000, prob=.01), type="o", col=4)

legend("topright", legend=c("n=20, p=.5", "n=50, p=.2", "n=1000, p=.01"), col=2, lty=1)
```
...
```{r fig.width=7, fig.height=6}
plot(1:20, dbinom(1:20, size=1000, prob=.01), type="o", col=2, ylab="P(X=k)", xlab="k", main="Binom dist for large n's around k=10 when mean(k)=10")
points(1:20, dbinom(1:20, size=10000, prob=.001), type="o", col=3)
points(1:20, dbinom(1:20, size=100000, prob=.0001), type="o", col=4)

legend("topright", legend=c("n=1000, p=.01", "n=10,000, p=.001", "n=100,000, p=.0001"), col=2, lty=1)
```
